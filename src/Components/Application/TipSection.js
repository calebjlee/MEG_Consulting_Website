        ...
        <SectionContainer>
            <ContentContainer>
                ...
                <TipContainer style={{height: clickId === 5 ? `${height4}px`:"15vh"}} onClick={() => clickId !== 5 ? setClickId(5):setClickId(0)}>
                    ...
                    <BodyText ref={measuredRef4}>We haven't finalized our written application but it typically includes a section about general info &#40;name, age, major etc.&#41; followed by a personal short answer question and a maybe a consulting short answer question. I think the most important thing to remember about the written application is that we read a lot if these applications so try to separate yourself: give us a reason to remember you! As for the consulting question, we care about your thought process not your final answer. Show you can do some critical analysis and out of the box thinking. &#40;also Googling common consulting questions might help!&#41;</BodyText>
                </TipContainer>
                ...
                <TipContainer style={{height: clickId === 6 ? `${height5}px`:"15vh"}} onClick={() => clickId !== 6 ? setClickId(6):setClickId(0)}>
                    ...
                    <BodyText ref={measuredRef5}>A behavioral interview is a common type of recruiting interview that involves applicants responding to a wide variety of questions that are meant to shine light on the applicant's past experiences, skills, and personality. To do well get to know some of them most common behavioral questions and come prepared with some past experiences that you can describe to your interviewer  </BodyText>
                </TipContainer>
