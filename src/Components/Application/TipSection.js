            ...
            <ContentContainer>
                <TipContainer style={{height: clickId === 1 ? `${height}px`:"15vh"}} onClick={() => clickId !== 1 ? setClickId(1):setClickId(0)}>
                    <TitleTextContainer>
                        ...
                        <BsPlusLg style={{marginRight:"1vw", marginLeft:"5vw", transform: clickId === 1 ? "rotate(45deg)":"none", transition: "transform .5s", fontSize: "3vmin"}}/>
                    </TitleTextContainer>
                ...
                <TipContainer style={{height: clickId === 2 ? `${height1}px`:"15vh"}} onClick={() => clickId !== 2 ? setClickId(2):setClickId(0)}>
                    <TitleTextContainer>
                        ...
                        <BsPlusLg style={{marginRight:"1vw", marginLeft:"5vw", transform: clickId === 2 ? "rotate(45deg)":"none", transition: "transform .5s", fontSize: "3vmin"}}/>
                    </TitleTextContainer>
                ...
                <TipContainer style={{height: clickId === 3 ? `${height2}px`:"15vh"}} onClick={() => clickId !== 3 ? setClickId(3):setClickId(0)}>
                    <TitleTextContainer>
                        ...
                        <BsPlusLg style={{marginRight:"1vw", marginLeft:"5vw", transform: clickId === 3 ? "rotate(45deg)":"none", transition: "transform .5s", fontSize: "3vmin"}}/>
                    </TitleTextContainer>
                ...
                <TipContainer style={{height: clickId === 4 ? `${height3}px`:"15vh"}} onClick={() => clickId !== 4 ? setClickId(4):setClickId(0)}>
                    <TitleTextContainer>
                        ...
                        <BsPlusLg style={{marginRight:"1vw", marginLeft:"5vw", transform: clickId === 4 ? "rotate(45deg)":"none", transition: "transform .5s", fontSize: "3vmin"}}/>
                    </TitleTextContainer>
                ...
                <TipContainer style={{height: clickId === 5 ? `${height4}px`:"15vh"}} onClick={() => clickId !== 5 ? setClickId(5):setClickId(0)}>
                    <TitleTextContainer>
                        ...
                        <BsPlusLg style={{marginRight:"1vw", marginLeft:"5vw", transform: clickId === 5 ? "rotate(45deg)":"none", transition: "transform .5s", fontSize: "3vmin"}}/>
                    </TitleTextContainer>
                ...
                <TipContainer style={{height: clickId === 6 ? `${height5}px`:"15vh"}} onClick={() => clickId !== 6 ? setClickId(6):setClickId(0)}>
                    <TitleTextContainer>
                        ...
                        <BsPlusLg style={{marginRight:"1vw", marginLeft:"5vw", transform: clickId === 6 ? "rotate(45deg)":"none", transition: "transform .5s", fontSize: "3vmin"}}/>
                    </TitleTextContainer>
                ...
                <TipContainer style={{height: clickId === 7 ? `${height6}px`:"15vh"}} onClick={() => clickId !== 7 ? setClickId(7):setClickId(0)}>
                    <TitleTextContainer>
                        ...
                        <BsPlusLg style={{marginRight:"1vw", marginLeft:"5vw", transform: clickId === 7 ? "rotate(45deg)":"none", transition: "transform .5s", fontSize: "3vmin"}}/>
                    </TitleTextContainer>
